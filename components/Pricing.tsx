    ...
    <section className="py-24 relative bg-white">
      <div className="container mx-auto px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-white p-12 rounded-[3rem] border border-gray-200 mb-10 relative overflow-hidden group shadow-2xl shadow-gray-200/50">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-purple-600 to-blue-600" />
            
            <div className="flex justify-center items-center gap-4 mb-4">
              <span className="text-2xl text-gray-400 line-through font-medium">R$ 29,90</span>
              <span className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-xs font-bold uppercase">80% OFF</span>
            </div>
            
            <div className="text-7xl md:text-8xl font-black text-gray-900 mb-4 tracking-tighter">
              R$ 5,90
            </div>
            
            <p className="text-gray-500 mb-10 text-lg">Pagamento único. Acesso imediato.</p>

            <button className="w-full bg-gray-900 text-white hover:bg-purple-600 py-6 rounded-2xl font-black text-xl md:text-2xl transition-all hover:scale-[1.02] active:scale-95 shadow-xl shadow-gray-900/10 flex items-center justify-center gap-3">
